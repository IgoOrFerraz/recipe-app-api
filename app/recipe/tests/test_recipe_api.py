...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 30,
            'price': Decimal('2.50'),
            'ingredients': [{'name': 'Rice'}, {'name': 'Shouyo'}]
        }
        res = self.client.post(RECIPE_URL, payload, format='json')
    ...
    def test_create_recipe_with_existing_ingredients(self):
        ...
        ingredient_test = Ingredient.objects.create(user=self.user,
                                                    name='Sugar')
        payload = {
            'title': 'Pongal',
            'time_minutes': 60,
            'price': Decimal('4.50'),
            'ingredients': [{'name': 'Sugar'}, {'name': 'Beans'}]
        }
        res = self.client.post(RECIPE_URL, payload, format='json')
    ...
    def test_create_ingredient_on_update(self):
        ...
        payload = {'ingredients': [{'name': 'Tomate'}]}
        url = detail_url(recipe.id)
        res = self.client.patch(url, payload, format='json')
    ...
    def test_update_recipe_assign_ingredient(self):
        ...
        ingredient_orange = Ingredient.objects.create(user=self.user,
                                                      name='Orange')
        ...
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        self.assertIn(ingredient_orange, recipe.ingredients.all())
        self.assertNotIn(ingredient_apple, recipe.ingredients.all())
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title='Augerbine with Tahini')
